...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-05-2023 a las 17:13:55
...
CREATE TABLE `evento` (
  ...
  `objetivo_evento` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `descripcion_evento` text COLLATE utf8_spanish_ci NOT NULL,
  `moneda_evento` text COLLATE utf8_spanish_ci NOT NULL,
  `actividad_evento` int(100) NOT NULL,
  `presupuesto_evento` double NOT NULL,
  `fechainicio_evento` date NOT NULL,
  `horainicio_evento` time NOT NULL,
  `fechafin_evento` date NOT NULL,
  `horafin_evento` time NOT NULL,
  `estado_evento` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `evento` (`id_evento`, `objetivo_evento`, `descripcion_evento`, `moneda_evento`, `actividad_evento`, `presupuesto_evento`, `fechainicio_evento`, `horainicio_evento`, `fechafin_evento`, `horafin_evento`, `estado_evento`, `id_usuario`) VALUES
(6, '5412JALSASD', 'Pruebas', 'COP', 78, 1200, '2023-05-17', '16:50:00', '2023-05-17', '16:51:00', 'ACTIVO', 15),
(7, '4551JASCS2', 'Pruebas', 'COP', 79, 4700, '2023-05-18', '08:33:00', '2023-05-18', '08:33:00', 'ACTIVO', 15),
(8, '455ADD2321', 'pRUEBAS3', 'EUR', 81, 5, '2023-05-18', '09:39:00', '2023-05-18', '09:39:00', 'ACTIVO', 15);
